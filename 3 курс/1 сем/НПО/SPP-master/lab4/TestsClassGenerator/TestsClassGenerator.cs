        ...
        public List<TestClass> GenerateTestClasses(string sourceCode)
        {
            ...
            foreach (var classDeclaration in classes)
            {
                List<MethodDeclarationSyntax> methods = classDeclaration.DescendantNodes()
                    .OfType<MethodDeclarationSyntax>().ToList().Where(method => method.Modifiers.ToList().Any(token => token.Text != "private")).ToList();
                ...
                result[index].Source += "{\n";
                result[index].Source += "\tpublic class " + classDeclaration.Identifier.ValueText + "Test";
                result[index].Source += "\t{\n";
                ...
                { 
                    ...
                    result[index].Source += "\t\t{\n";
                    result[index].Source += "\t\t\tAssert.False(true, \"autogenerated\");\n";
                    result[index].Source += "\t\t}\n";
                    result[index].Source += "\t\t\n";
                }
