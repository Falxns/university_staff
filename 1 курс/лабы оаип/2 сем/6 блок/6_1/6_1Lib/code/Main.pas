...
type
  ...
  procedure _AddHead(var Head, CopyHead: Pointer); stdcall; external 'ListLib.dll';
  procedure _AddEl(var Head, Buff: Pointer; var Str: String); stdcall; external 'ListLib.dll';
