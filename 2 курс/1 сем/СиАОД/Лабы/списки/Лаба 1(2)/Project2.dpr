{
1.Вводим значение N;
2.Создаем список из N детей;
3.Вводим k(каждого k-ого ребенка будем удалять);
4.Выводим номер ребенка которого будем удалять;
5.Удаляем этого ребенка;
6.Повторяем 4 и 5 пока не останется один ребенок;
7.Выводим номер последнего оставшегося ребенка;
8.Выводим номера последних оставшихся детей для N = 1..64 и k,введенного ранее.
}
